...
def get_user_list(config, key):
    with open("{}/DarlingRobot/{}".format(os.getcwd(), config), "r") as json_file:
...
class Config(object):
    ...
    OWNER_USERNAME = "clauderis"
    SUPPORT_CHAT = "purpleplaneteers"  # Your own group for support, do not add the @
    JOIN_LOGGER = (
        -1001180007354
